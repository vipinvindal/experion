		...
		<tr class = "trBody" align = "center">
			<td>
				<table class="bodyHeader">
					...
					<s:form method="post"
						action="./featureUpdate.html?"
						modelAttribute="feature" enctype="multipart/form-data">

						<tr>
						<td align = "center">
							<table class="bodyTableProjectFeature" border="1">
						<tr>
						<td align="center" colspan="0" class="bodyTableTrHeader">Project Name</td>
						<td align="left" colspan="0"><s:input type="text" path="projectName"  disabled ="true" />
							
							<s:input type="hidden" path="projectId"  /></td>
						</tr>
                        <tr>
						...
						<s:textarea class="textArea" cols="40" rows="10" path="feature" />
						...
						<td align="center" colspan="2">
						  <s:input type="hidden" path="featureId"  />
							<input type="submit" value="Update Feature" /></td>
						</tr>
