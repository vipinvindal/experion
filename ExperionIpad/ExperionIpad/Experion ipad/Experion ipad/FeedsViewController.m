...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *feedsLogo=[[_feedsListArr objectAtIndex:indexPath.row] objectForKey:@"feedLogo"];
    if (feedsLogo==nil) {
        feedsLogo=@" ";
    }
   
    [acyimgeview loadimage:@"" :feedsLogo];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    feedsPreviewVC.imageURLStr = feedsLogo;//[[_feedsListArr objectAtIndex:indexPath.row] objectForKey:@"feedLogo"];
